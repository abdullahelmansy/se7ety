...
class _DoctorDetailsViewState extends State<DoctorDetailsView> {
  ...
  String _specialization = specializations[0];
  ...
  Future<String> uploadImageToFireStore(File image) async {
    Reference ref =
        FirebaseStorage.instanceFor(bucket: 'gs://se7tey-8a680.appspot.com')
            .ref()
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthBloc, AuthState>(
      listener: (context, state) {
        ...
        } else if (state is DoctorDetailsLoadingState) {
                      ...
                      Container(
                        ...
                        child: DropdownButton(
                          ...
                          onChanged: (String? newValue) {
                            setState(() {
                              _specialization = newValue ?? specializations[0];
                            });
                          },
            ...
            child: ElevatedButton(
              onPressed: () async {
                if (_formKey.currentState!.validate() && file != null) {
                  ...
                  context.read<AuthBloc>().add(DoctorDetailsEvent(
